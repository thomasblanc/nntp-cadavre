...
(* OASIS_START *)
(* DO NOT EDIT (digest: f32003b93b923d49a6e2bd12678b4b64) *)
(*
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Post a random text on a nntp server";
          description = None;
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "data_edit.ml"; });
               Executable
                 ({
                     cs_name = "gen_data";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "gen_data.ml"; });
               Executable
                 ({
                     cs_name = "tester";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      bs_path = ".";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "nntplight"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "test_nntp.ml"; });
               Executable
                 ({
                     cs_name = "cadavre";
                     cs_data = PropList.Data.create ();
